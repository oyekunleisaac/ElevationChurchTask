            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="resAd" class="col-md-4 col-form-label text-md-end">{{ __('Residential address') }}</label>

                            <div class="col-md-6">
                                <input id="resAd" type="text" class="form-control @error('resAd') is-invalid @enderror" name="resAd" value="{{ old('resAd') }}" required autocomplete="resAd" autofocus>
